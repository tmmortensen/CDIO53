...
public interface IBoundary {
	 ...
	 * 
	 * @return <code>login[]</code> where <code>login[0]</code> is the entered user ID and <code>login[1]</code> is the entered password
	 */
	public String[] login();
	 ...
	 * 
	 * @param msg a message to the operator
	 ...
	 * 
	 * @param options an array of strings containing the text for each option
	 * @param header the header for the menu
	 * @return the # of the option chosen by the operator - with 0 being the first option
	 */
