<%@ page language="java" import="java.util.*, java.text.*, java.lang.*, data.*" 
...
<body>
<jsp:useBean id="test" class="data.Test" scope="session"/>
	...
	%>
	<div class="dialog">
		<h1>Oprettelse af Recept <% out.print(test.plus()); %></h1>
		<form method="post">
