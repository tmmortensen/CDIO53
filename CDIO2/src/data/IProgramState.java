...
public interface IProgramState {
	 ...
	 * @param since the system time in milliseconds from when we're interested in updates 
	 ...
	 * @param since the system time in milliseconds from when we're interested in input 
	 ...
	 * @param port the port number to be stored
	 */
	 ...
	 * @param text the text to be set on the display
	 */
	 ...
	 * @return <code>true</code> until <code>quit()</code> has been executed
	 * and <code>false</code> after <code>quit()</code> has been executed. 
	 */
